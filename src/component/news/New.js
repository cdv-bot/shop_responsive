      ...
      <div className='new_list'>
        <div className='div_slider'>
          ...
          <Slider {...settings} ref={slider}>
            ...
            <img src={new1} alt='slider' className='img_width' />
            <img src={new2} alt='slider' className='img_width' />
          </Slider>
          <FontAwesomeIcon
            icon={faChevronRight}
            onClick={next}
        ...
        <div className='new_sale'>
          <div className='item_new'>
            <div className='hover'>
              <img src={new2} alt='new1' className='img_item_new' />
          ...
          <div className='item_new'>
            <div className='hover'>
              <img src={new1} alt='new1' className='img_item_new' />
              <div className='hover_background'>
                <span>
                  <FontAwesomeIcon icon={faPlusCircle} className='icon_logo' />
                </span>
